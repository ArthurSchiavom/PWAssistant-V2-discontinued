...
public abstract class Questionnaire {
	...
	/**
	 * Start this questionnaire with the default configuration.
	 *
	 * @param event The event that requested the questionnaire.
	 */
	...
	/**
	 * Set the questionnaire's default configuration such as which messages to delete by default.
	 */
	...
	/**
	 * Adds a question to this questionnaire.
	 *
	 ...
	 * @return If the event was a questionnaire target and therefore processed.
	 */
	...
	/**
	 * Verifies if an event is target of this questionnaire's analysis.
	 *
	 * @param event The event to analyse.
	 * @return If the event is target of this questionnaire's analysis.
	 */
	...
	/**
	 * Verifies if a user+channel is target of this questionnaire's analysis.
	 *
	 * @param userId The user's ID.
	 * @param channelId The channel's ID.
	 * @return If the user+channel is target of this questionnaire's analysis.
	 */
	 ...
	 * <br>* (1) Ends the questionnaire or (2) asks the question and queues it for deletion if appliable.
	 *
	 * @param questionText The question text or null to end the questionnaire.
	 */
	...
	/**
	 * Adds a message to delete at the end of the questionnaire.
	 *
