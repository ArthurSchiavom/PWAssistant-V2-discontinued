...
public abstract class Command {
     ...
     *                                 <br>This avoids processing the same message repeatedly for multiple commands.
    ...
    /**
     * Builds the help message based on the current information stored.
     */
    public abstract void buildHelpMessage();

    /**
     * @return The amount of commands involved in the chain of super commands.
     * <br>Example: The command "!trigger register fixed [arguments...]" has 3 commands in the chain: "trigger", "register" and "fixed".
     */
