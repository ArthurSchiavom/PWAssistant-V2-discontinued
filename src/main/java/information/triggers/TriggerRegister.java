...
public class TriggerRegister {
	...
	/**
	 * Unregisters a trigger. (From memory and database)
	 *
	 ...
	 * <br>FAILED_DATABASE_MODIFICATION if failed because the database was not reachable. (cache was left unchanged as well)
	 */
	public CacheModificationSuccessState unregister(long guildId, @NotNull String triggerName) {
		List<Trigger> guildTriggers = guildsTriggers.get(guildId);
		if (guildTriggers == null)
