...
public class PlayerManager {
	 ...
	 *
	 * @param guildId
	 * @return (1) The registered music manager for the guild or (2) null if no music manager is registered for the given guild ID.
	 */
	...
	/**
	 * Gets a registered guild music manager or registers a new one if none is registered.
	 *
	...
	/**
	 * Joins the music channel and registers a new guild music manager.
	 *
	 * @param guild The guild.
	 * @return The registered guild music manager.
	 */
